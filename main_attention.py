...
from model import spectroedanet_attention
...
model = spectroedanet_attention.SpectroEDANet(usesSpectrogram, usesEDA, usesMusic, predictsArousal, predictsValence)
...
for fold, (train_idx, val_idx) in enumerate(kfold.split(dataset)):
    ...
    for epoch in range(num_epochs):
        ...
        for i, data in enumerate(train_loader, 0):
            spectrogram, eda_data, arousal_label, valence_label, _ = data
