...
from model import spectroedanet_EDA
...
def main(usesSpectrogram=True,
         ...
         dataset=None) -> (
        tuple[
            spectroedanet_EDA.SpectroEDANet,
            dict[str, Any],
            list[float],
            list[float],
            float | None,
    ...
    model = spectroedanet_EDA.SpectroEDANet(usesSpectrogram,
                                        usesEDA,
                                        usesMusic,
                                        usesAttention,
                                        predictsArousal,
    ...
    # Use Weight decay regularization, also known as L2 regularization, as well as a higher learning rate:
    ...
    filename = 'checkpoints_EDA/model_weights_'
    if usesSpectrogram:
